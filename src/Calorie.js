...
export default class CalorieScrren extends Component {
  state = {
    visibleModal: null,
  };
    ...
    return (
      <View style={styles.main}>
        <View style={{height:80, width:"100%"}}>
          <Text style={{margin:20,fontSize:16, fontWeight:"bold"}}>Calorie Intake</Text>
          <Text style={{marginLeft:20,fontSize:16, fontWeight:"bold"}}>KCal   {this.state.total}.0</Text>
        </View>
